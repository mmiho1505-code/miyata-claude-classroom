...
今日の日付を大きく表示`)}
      ...
      },
      {
        ...
        body: `
            ...
            <p>ポータルはある。タイムカードだけ足したい、というときの見本です。</p>
            ${box(`いまの社内ポータルに、「出退勤」の機能を追加してください。
...
できたら、社員が開けるリンクをください。`)}
            ...
            <div class="callout">いちばん大事なのは「いまあるものは消さない」と「記録は保存して消えないように」の2つです。</div>
          `
      },
      {
        id: "safety",
      ...
      },
      {
        ...
        body: `
            ...
            <p>あとからボタンや画面を足すときは <a href="#/course/attend/addfeat" data-link>機能を足す</a> です。</p>
