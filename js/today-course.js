    ...
    lessons: [
      ...
      },
      {
        ...
        body: `
            ...
            <p>時間があれば Gmail → カレンダー → ドライブの順。1つで止まっても次へ進んでよいです。</p>
            <p>① Gmail</p>
...
・会社のGoogleアカウントを使います`)}
            ...
            <div class="qa">
              <p class="qa-q">つながらない</p>
              <p>有料プランか、会社がまだ許可していないことがある。無理に探さない。「ポータルを作る」へ</p>
            </div>
            <div class="qa">
              <p class="qa-q">やってはいけない</p>
              <p>パスワードを貼る。メールを送る。予定やファイルを消す。個人の Google でつなぐ</p>
            </div>
            <p>つながった人だけ、試します。送る・消すはしません。</p>
            <p>Gmail</p>
