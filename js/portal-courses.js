...
できたら、社員が開けるリンクをください。`)}
      ...
      },
      {
        ...
        body: `
            ...
            <div class="ops">
              <article class="op"><span class="num">1</span><h3>誰が使うか</h3><p>例をコピーして、お願い文に足してください。</p></article>
            </div>
            ${box(`誰が使うか：全社員が毎朝開く`)}
            <div class="ops">
              <article class="op"><span class="num">2</span><h3>何を載せるか</h3><p>例をコピーして、お願い文に足してください。</p></article>
            </div>
            ${box(`何を載せるか：お知らせ、予定、リンク、連絡先`)}
            <div class="ops">
              <article class="op"><span class="num">3</span><h3>どんな感じか</h3><p>例をコピーして、お願い文に足してください。</p></article>
            </div>
            ${box(`どんな感じか：落ち着いた緑、文字は大きめ`)}
            <p>下は、そのままでも使える具体文です。［　］だけ自分の会社に直して、Cowork に貼ってください。</p>
            <h2>1. 誰が使うか</h2>
            ${box(`使う人は、パソコンが苦手な人も含めた全社員です。
毎朝、出勤したら最初に開くページにしてください。
スマホからも見ます。ログインは不要で、リンクを知っている社員だけが見られるようにしてください。`)}
            <h2>2. 何を載せるか</h2>
            ${box(`1ページに、次の4つを載せてください。

・お知らせ：新しいものが上。日付つき。いまは3件
　1）10/20 棚卸しのため午後休業
　2）10/25 健康診断（午前）
　3）10/31 経費精算の提出期限
・今月の予定：会議・休業・提出期限
・よく使うリンク：勤怠、社内メール、共有フォルダ。アドレスは仮でOK
・部署の連絡先：総務 山田（内線101）、経理 佐藤（内線102）、営業 鈴木（内線201）`)}
            <h2>3. どんな感じか</h2>
            ${box(`見た目は、落ち着いた緑（または青）。派手な色は使わないでください。
文字は大きめ。お年寄りでも読める大きさ。
いちばん上に社名「株式会社 宮田財務」。
ボタンやリンクは指で押しやすい大きさ。パソコンでもスマホでも崩れないように。`)}
            <h2>3つをまとめた見本</h2>
            <p>初めて作るときは、この1本をそのまま貼って大丈夫です。</p>
            ${box(`当社の社内ポータルを1ページ作ってください。

誰が使うか
・パソコンが苦手な人も含めた全社員が、毎朝最初に開く
・スマホからも見る。ログインは不要

何を載せるか
・お知らせ（新しいものが上、日付つき、3件まで）
　10/20 棚卸しのため午後休業
　10/25 健康診断（午前）
　10/31 経費精算の提出期限
・今月の予定（会議・休業・提出期限）
・よく使うリンク（勤怠・メール・社内フォルダ。URLは仮でOK）
・部署の連絡先
　総務 山田 内線101
　経理 佐藤 内線102
　営業 鈴木 内線201
...
できたら、社員が開けるリンクをください。`)}
            <p>直し方は <a href="#/course/portalfix" data-link>直し方編</a> です。仮の日付や内線でも、あとから差し替えできます。</p>
          `
      },
      {
        id: "answer",
